...
parser.add_argument('--output', default='/home/roit/datasets/Binjiang/0020_int6', help="Output folder. If exists it will be removed")
parser.add_argument('--skip',default=6)
